...
type Trace struct {
	...
	StaySec  int64  `protobuf:"varint,3,opt,name=stay_sec,json=staySec,proto3" json:"stay_sec,omitempty"`
	VieePage string `protobuf:"bytes,4,opt,name=viee_page,json=vieePage,proto3" json:"viee_page,omitempty"`
}
...
func (x *Trace) GetLocation() string {
	if x != nil {
		return x.Location
	}
	return ""
...
func (x *Trace) GetVieePage() string {
	if x != nil {
		return x.VieePage
	}
	return ""
...
var file_trace_proto_rawDesc = []byte{
	0x0a, 0x0b, 0x74, 0x72, 0x61, 0x63, 0x65, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x12, 0x04, 0x6e,
	0x65, 0x72, 0x76, 0x22, 0x6f, 0x0a, 0x05, 0x54, 0x72, 0x61, 0x63, 0x65, 0x12, 0x12, 0x0a, 0x04,
